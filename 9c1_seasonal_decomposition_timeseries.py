    ...
    for i, mooring_name in enumerate(moorings):
       ...
       # tren=trends(ax2,trd.index,trd.values)
        ...
        if t=='magnitude':
            ...
            #if i>=5:
            if typ=='both':
                ax1.text(np.datetime64('2011-06-01'),-0.16,tex,fontsize=10)
            else:
        ...
        if typ=='both':
            ax1.text(np.datetime64('1999-01-01'),0.025,'Larger air-sea flux',fontsize=11)
            #if i>2:
            ax1.text(np.datetime64('1999-01-01'),-0.16,'Larger new production',fontsize=11)
        #else:
        ...
        #print(trd[-1],trd[0])
        if typ=='both':
            ax2.text(np.datetime64('1999-01-01'),0.025,'Larger air-sea flux',fontsize=11)
        #if i<4:
            ax2.text(np.datetime64('1999-01-01'),-0.12,'Larger new production',fontsize=11)
        #else:
