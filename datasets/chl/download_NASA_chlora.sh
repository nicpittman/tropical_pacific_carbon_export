...
wget -q --post-data="sensor=seawifs&sdate=1997-09-01&edate=2010-12-01&dtype=L3M&addurl=1&results_as_file=1&search=*DAY_CHL_chlor_a_9km*" -O - https://oceandata.sci.gsfc.nasa.gov/api/file_search > seawifs.txt

#Download MODIS file urls to modis.txt
wget -q --post-data="sensor=modis_aqua&sdate=2002-01-01&edate=2020-12-01&dtype=L3M&addurl=1&results_as_file=1&search=*DAY_CHL_chlor_a_9km*" -O - https://oceandata.sci.gsfc.nasa.gov/api/file_search > modis.txt
