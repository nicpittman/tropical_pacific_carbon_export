...
Heat Content (10*10 J / m**2) is computed by vertically 
integrating the temperature profile from the surface to 
300 meters depth using the trapezoid rule and multiplying 
the integral by the specific heat and density, both of 
which are assumed to be constant values as follows:

  from "Atmosphere-Ocean Dynamics", Adrian E. Gill:

  Specific Heat: 3940.0 J/kg*K  P601, Gill
  Density:       1022.4 kg/m**3 P599, Gill
