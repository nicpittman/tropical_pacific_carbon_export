...
The depth of the 20 degree (C) isotherm is calculated from 
temperature profiles using linear interpolation of 
depth vs temperature. The maximum distance between 
temperatures is 50m, and is typically 20 or 25 meters.
