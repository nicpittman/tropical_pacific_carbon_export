...
and in hourly and daily ascii files you will also find 
instrument codes. All of these codes are defined below.

In ascii format files with all sites in one file, you
will find only quality codes along with the salinity
data.

In NetCDF format files you will find quality and source 
code variables, each with the same shape as the data.
In hourly and daily NetCDF which contain the data for
just one mooring site, you will also find a variable 
containing the instrument code.
