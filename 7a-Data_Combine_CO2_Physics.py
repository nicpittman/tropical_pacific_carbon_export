...
Unfortunately I really messed this up. If I did it again, I would construct it day by day, rather than the looping method used here that takes FOREVER. 
Several of the processed version are available in: combined_datasets/*_data.nc The main version used is month_data_exports.nc
