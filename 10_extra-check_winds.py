...
plt.subplot(325)
plt.scatter(dat.precip,dat.laws2011a*dat.cafe,label='NP (mgC/day)',alpha=0.9)
plt.scatter(dat.precip,(dat.co2flux4_land_gmyr/365)*1000,label='CO2 flux (mgC/day)',alpha=0.5)
plt.scatter(dat.precip,dat.delta_pCO2,label='delta pCO2 (uatm)',alpha=0.45)
#plt.legend()
trends(dat.precip.values.flatten(),(dat.laws2011a*dat.cafe).values.flatten(),c='b')
trends(dat.precip.values.flatten(),((dat.co2flux4_land_gmyr/365)*1000).values.flatten(),c='orange')
trends(dat.precip.values.flatten(),((dat.delta_pCO2)).values.flatten(),c='darkgreen')
